            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white shadow-lg rounded-lg p-4 sm:p-6 border border-gray-200">
                <div className="flex items-center mb-4 sm:mb-6">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg flex items-center justify-center mr-3">
                ...
                <form onSubmit={editingProduct ? handleUpdate : handleSubmit} className="space-y-4 sm:space-y-5">
              ...
              <div className="bg-white shadow-lg rounded-lg p-4 sm:p-6 border border-gray-200">
                <div className="flex items-center mb-4 sm:mb-6">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-green-500 to-green-600 rounded-lg flex items-center justify-center mr-3">
                    <svg className="w-4 h-4 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                    </svg>
                  </div>
                  <div>
                    <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Uploaded Products</h2>
                ...
                <div className="space-y-3 sm:space-y-4 max-h-96 overflow-y-auto">
                  {products.length === 0 ? (
                    <div className="text-center py-8 sm:py-12">
                      ...
                      <p className="text-gray-500 text-base sm:text-lg mb-2">No products uploaded yet</p>
                      <p className="text-gray-400 text-sm">Upload your first product to get started</p>
                    </div>
                  ) : (
                    products.map((product) => (
                      <div key={product._id} className="border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow duration-200">
                        <div className="flex flex-col sm:flex-row sm:items-start space-y-3 sm:space-y-0 sm:space-x-4">
                          ...
                          <div className="flex-1 min-w-0 text-center sm:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-2 space-y-2 sm:space-y-0">
                              <span className="text-xs text-blue-600 bg-blue-50 px-2 py-1 rounded-full font-medium self-center sm:self-start">
                                {product.category}
                              </span>
